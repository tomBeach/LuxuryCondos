...
function activateRoomSelect() {
    ...
    document.getElementById("selRoom").addEventListener("change", setSelectedRoom, false);
    // $('#selRoom').change(setSelectedRoom);
}
// ======= activateClearSelection =======
function activateClearSelection() {
    console.log("== activateClearSelection ==");
    document.getElementById("clearBtn").addEventListener("click", clearSelectedRoom, false);
...
var x = 5;
var varIsNaN = Number.isNaN(x);
console.log("varIsNaN: ", varIsNaN);
