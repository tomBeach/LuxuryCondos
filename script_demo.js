...
var myCondo = {
    ...
    makeDraggers: function() {
        ...
        $.each(myCondo.draggers, function(key, dragObj) {
            ...
            nextDragEl.id = key;
            nextDragEl.className = "dragger " + dragObj.class;
            nextStyles = "position:absolute; ";
    ...
    dropItem: function(e) {
        ...
        // console.log(".X: ", myCondo.draggers[myCondo.activeDragger.id].X);
        // console.log(".Y: ", myCondo.draggers[myCondo.activeDragger.id].Y);
        // console.log("myCondo.activeDragger.id: ", myCondo.activeDragger.id);
        // console.log(".left: ", $(myCondo.activeDragger.el).offset().left);
        // console.log(".top: ", $(myCondo.activeDragger.el).offset().top);
